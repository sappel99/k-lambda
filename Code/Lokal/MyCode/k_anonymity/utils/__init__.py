...
#default_data_config = {
#    'path': 'data/10k_3QI_output_1.csv',
#    # QI for samarati
...
#        'GENDER': 'data/my_adult_gender.txt',
#    },
#}

#default_data_config = {
#    'path': 'data/10k_6QI_output_1.csv',
#    # QI for samarati
...
#        'BIRTHDATE': None,  # range type generalization
##        'BIRTHDATE': 'data/my_adult_birthdate.txt',
#        'RACE': 'data/my_adult_race.txt',
#        'ETHNICITY': 'data/my_adult_ethnicity.txt',
#        'GENDER': 'data/my_adult_gender.txt',
#        'BIRTHPLACE': 'data/my_adult_birthplace.txt',
#    },
#}

default_data_config = {
    'path': 'data/10k_9QI_output_1.csv',
    # QI for samarati
   ...
   'samarati_generalization_type': {
    ...
    'hierarchies': {
        ...
        'FIRST': 'data/my_adult_first.txt',
        'LAST': 'data/my_adult_last.txt',
        'RACE': 'data/my_adult_race.txt',
        'ETHNICITY': 'data/my_adult_ethnicity.txt',
        'GENDER': 'data/my_adult_gender.txt',
        'BIRTHPLACE': 'data/my_adult_birthplace.txt',
